...
public class CircleBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        progressColor = typedArray.getColor(R.styleable.CircleBarView_stkProgressColor, Color.GREEN);
        bgColor = typedArray.getColor(R.styleable.CircleBarView_stkBgColor,Color.GRAY);
        startAngle = typedArray.getFloat(R.styleable.CircleBarView_stkStartAngle,0);
        sweepAngle = typedArray.getFloat(R.styleable.CircleBarView_stkSweepAngle,360);
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_stkBarWidth, SizeUtils.dp2px(10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize = SizeUtils.dp2px(100);
        mRectF = new RectF();
