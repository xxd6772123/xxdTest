...
public class TransformImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //获得自定义属性
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TransformImageView);
        //最大缩放比例因子
        float maxScaleFactor = typedArray.getFloat(R.styleable.TransformImageView_stk_max_scale_factor, DEFAULT_MAX_SCALE_FACTOR);
        //最小缩放比例因子
        float minScaleFactor = typedArray.getFloat(R.styleable.TransformImageView_stk_min_scale_factor, DEFAULT_MIN_SCALE_FACTOR);
        //是否能够平移回弹
        boolean canBackTranslate = typedArray.getBoolean(R.styleable.TransformImageView_stk_can_back_translate, true);
        //是否能够旋转回弹
        boolean canBackRotate = typedArray.getBoolean(R.styleable.TransformImageView_stk_can_back_rotate, false);
        //是否能够缩放回弹
        boolean canBackScale = typedArray.getBoolean(R.styleable.TransformImageView_stk_can_back_scale, true);
        //动画持续的时间
        int animatorTime = typedArray.getInt(R.styleable.TransformImageView_stk_animator_time, DEFAULT_ANIMATOR_TIME);
        typedArray.recycle();
        //设置自定义属性
