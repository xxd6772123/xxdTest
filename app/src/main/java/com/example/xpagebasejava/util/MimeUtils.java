...
public final class MimeUtils {
    ...
    public static boolean isSpecMimeType(String filePath, String mimePrefix) {
    ...
    /**
     * 根据某一文件路径判断该文件是否为视频文件
     *
     * @param filePath
     * @return
     */
    public static boolean isVideoMimeType(String filePath) {
        return isSpecMimeType(filePath, "video");
    }

    /**
     * 根据某一文件路径判断该文件是否为图片文件
     *
     * @param filePath
     * @return
     */
    public static boolean isImgMimeType(String filePath) {
        return isSpecMimeType(filePath, "image");
    }
     ...
     * @return
     */
    public static boolean isAudioMimeType(String filePath) {
        return isSpecMimeType(filePath, "audio");
    }
}
