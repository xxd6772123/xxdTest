...
import com.example.xpagebasejava.util.ObjectUtil;
import com.example.xpagebasejava.util.StatusBarUtils;
import com.example.xpagebasejava.util.ToastUtil;
 ...
 */
public abstract class BaseTabFragmentHomeActivity<DB extends ViewDataBinding> extends BaseActivity<DB> {
