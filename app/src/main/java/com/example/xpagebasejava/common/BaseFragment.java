...
import com.example.xpagebasejava.dialog.LoadingDialog;


/**
 * time:2022/6/25 16:45
 */
...
//        EventStatProxy.getInstance().statPage(getActivity(), getPageType(), () -> onItemClickCallback(adapter,view,position));
//    }
